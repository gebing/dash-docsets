...
def add_infoplist(info_path, index_page):
    ...
    """.format(docset_title, docset_title, docset_title, docset_key, index_page)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-k', '--key',
                        help='Keyword the docset explicitly')
    ...
    if not results.name:
        ...
        docset_title = dir_name
    else:
        docset_name = results.name + ".docset"
        docset_title = results.name

    if not results.key:
        docset_key = docset_title
    else:
        docset_key = results.key
